...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'notification_notification', 'comment',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'notification_notification', 'comment')
    ...
    models = {
        ...
        u'notification.notification': {
            ...
            'comment': ('django.db.models.fields.TextField', [], {'default': "'NONE'"}),
