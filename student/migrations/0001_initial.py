...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'student', ['Course'])
        ...
        # Adding M2M table for field coursetaken on 'student_profile'
        m2m_table_name = db.shorten_name(u'student_student_profile_coursetaken')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('student_profile', models.ForeignKey(orm[u'student.student_profile'], null=False)),
    ...
    def backwards(self, orm):
        # Deleting model 'faculty_profile'
        db.delete_table(u'student_faculty_profile')

        # Deleting model 'Course'
        db.delete_table(u'student_course')

        # Deleting model 'student_profile'
        db.delete_table(u'student_student_profile')
