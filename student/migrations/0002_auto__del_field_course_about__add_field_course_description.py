...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Course.about'
        db.delete_column(u'student_course', 'about')

        # Adding field 'Course.description'
        db.add_column(u'student_course', 'description',
                      self.gf('django.db.models.fields.TextField')(default='There is no description'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Course.about'
        db.add_column(u'student_course', 'about',
                      self.gf('django.db.models.fields.TextField')(default='There is no description'),
                      keep_default=False)

        # Deleting field 'Course.description'
        db.delete_column(u'student_course', 'description')
