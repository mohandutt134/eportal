...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'student_course', 'dept', self.gf('django.db.models.fields.CharField')(max_length=5))

    def backwards(self, orm):

        # Changing field 'Course.dept'
        db.alter_column(u'student_course', 'dept', self.gf('django.db.models.fields.CharField')(max_length=3))
